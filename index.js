...
async function computeAdmitProbability(answers, university, destCode) {
  // Frontend always converts to percentage before sending — always use INDIA_PCT
  const systemCode = 'INDIA_PCT';
...
const FIELD_CATEGORY_KEYWORDS = {
  // Excludes: CS/software/data (→ computer science & data technology)
  // Excludes: architecture (→ arts, design & creative studies)
  // Excludes: environmental engineering (→ environment, sustainability & agriculture)
  "engineering & technology": [
    ...
    "aerospace engineering", "aeronautical engineering", "biomedical engineering",
    "manufacturing engineering", "industrial engineering", "control engineering",
    "systems engineering", "robotics", "automation", "mechatronics",
    "telecommunications", "petroleum engineering", "mining engineering",
    "nuclear engineering", "engineering management", "advanced manufacturing",
    "propulsion", "avionics", "acoustical engineering", "photonics",
    "power engineering", "energy engineering",
  ],
  "computer science & data technology": [
    ...
    "information security", "network security", "cloud computing",
    "human-computer interaction", "user experience", "web development",
    "database", "programming", "algorithms", "digital technology",
    "internet of things",
  ],
  // Excludes: biology/biochemistry/genetics (→ life sciences & biotechnology)
  "natural sciences": [
    "mathematics", "pure mathematics", "applied mathematics", "statistics",
    "physics", "astronomy", "astrophysics", "cosmology", "chemistry",
    "organic chemistry", "inorganic chemistry", "physical chemistry",
    "analytical chemistry", "earth science", "geology", "geophysics",
    "geoscience", "oceanography", "atmospheric science", "meteorology",
    "materials science", "nanoscience", "nanotechnology", "metallurgy",
    "polymer science", "optics", "nuclear physics",
  ],
  "life sciences & biotechnology": [
    "biological sciences", "biology", "biochemistry", "molecular biology",
    "genetics", "genomics", "cell biology", "biotechnology", "bioengineering",
    "bioinformatics", "neuroscience", "neurobiology", "microbiology",
    "immunology", "virology", "bacteriology", "zoology", "ecology",
    "systems biology", "structural biology", "evolutionary biology",
    "marine biology", "plant biology",
  ],
  // Excludes: nursing/physio/public health (→ public health & allied health)
  "medicine & clinical health": [
    "medicine", "medical", "surgery", "surgical", "physician",
    "clinical medicine", "paediatrics", "obstetrics", "gynaecology",
    "oncology", "cardiology", "neurology", "radiology", "anaesthesia",
    "psychiatry", "dentistry", "dental", "orthodontics", "oral surgery",
    "pharmacy", "pharmacology", "pharmaceutical", "drug discovery",
    "veterinary", "veterinary medicine", "animal medicine", "pathology",
    "haematology", "biomedical science", "medical imaging", "diagnostic",
  ],
  "public health & allied health": [
    "public health", "epidemiology", "global health", "health policy",
    "community health", "population health", "health promotion",
    "health management", "health informatics", "health systems",
    "nursing", "midwifery", "nurse practitioner", "physiotherapy",
    "physical therapy", "occupational therapy", "speech and language",
    "speech therapy", "audiology", "optometry", "podiatry", "radiography",
    "anatomy", "physiology", "kinesiology", "sports science",
    "exercise science", "strength and conditioning", "sports coaching",
    "nutrition", "dietetics", "mental health", "counselling",
    "clinical psychology", "rehabilitation",
  ],
  // Excludes: economics/finance/accounting (→ economics, finance & accounting)
  "business & management": [
    "business administration", "mba", "management", "strategic management",
    "organisational behaviour", "leadership", "marketing", "brand management",
    "advertising", "consumer behaviour", "digital marketing", "supply chain",
    "logistics", "operations management", "project management",
    "human resource management", "people management", "entrepreneurship",
    "innovation management", "international business", "retail management",
    "corporate strategy",
  ],
  "economics, finance & accounting": [
    "economics", "econometrics", "economic policy", "development economics",
    "macroeconomics", "microeconomics", "political economy", "finance",
    "financial management", "corporate finance", "investment", "banking",
    "financial analysis", "fintech", "risk management", "wealth management",
    "accounting", "auditing", "taxation", "financial reporting",
    "actuarial", "actuarial science", "quantitative finance",
    "operations research",
  ],
  // Excludes: politics/IR (→ law, politics & governance)
  // Excludes: history/philosophy/languages (→ humanities & languages)
  "social sciences": [
    "sociology", "social theory", "social research", "psychology",
    "applied psychology", "occupational psychology", "forensic psychology",
    "health psychology", "sport psychology", "neuropsychology",
    "criminology", "criminal justice", "crime science",
    "geography", "human geography", "urban studies", "urban planning",
    "gis", "development studies", "international development", "area studies",
    "social policy", "social work", "social welfare", "youth studies",
    "gender studies", "cultural studies", "migration studies", "cognitive science",
  ],
  "humanities & languages": [
    "history", "historical studies", "medieval history", "modern history",
    "ancient history", "philosophy", "ethics", "philosophy of mind",
    "metaphysics", "linguistics", "applied linguistics",
    "computational linguistics", "translation", "interpreting",
    "languages", "english language", "english literature", "literature",
    "comparative literature", "creative writing", "screenwriting",
    "anthropology", "social anthropology", "cultural anthropology",
    "archaeology", "heritage studies", "museum studies", "theology",
    "religious studies", "divinity", "communication studies",
    "media studies", "journalism", "broadcasting", "public relations",
  ],
  "arts, design & creative studies": [
    "fine art", "graphic design", "illustration", "visual communication",
    "fashion design", "textile design", "interior design", "product design",
    "industrial design", "contemporary art", "art practice",
    "architecture", "architectural design", "urban design",
    "landscape architecture", "sustainable architecture",
    "music", "musical performance", "composition", "musicology",
    "music technology", "sound design", "drama", "theatre", "acting",
    "directing", "dance", "choreography", "performing arts",
    "film", "cinema", "animation", "game design", "visual effects",
    "photography", "history of art", "curating", "curatorial",
  ],
  // Absorbs Politics & IR from social sciences
  "law, politics & governance": [
    "law", "legal studies", "llm", "juris", "jurisprudence",
    "commercial law", "corporate law", "international law", "maritime law",
    "tax law", "intellectual property", "environmental law",
    "human rights law", "constitutional law", "criminal law", "public law",
    "politics", "political science", "international relations",
    "global politics", "diplomacy", "security studies", "conflict studies",
    "foreign policy", "comparative politics", "european politics",
    "public policy", "public administration", "governance", "policy analysis",
    "regulatory affairs", "library science", "information management",
  ...
  "education & teaching": [
    ...
    "school psychology", "applied child psychology", "adult education",
    "literacy", "tesol", "teaching english", "language education",
    "immersion", "inclusive education", "send", "educational policy",
    "learning and development",
  ],
  "environment, sustainability & agriculture": [
    "environmental science", "environmental management", "environmental policy",
    "climate change", "sustainability", "sustainable development",
    "renewable energy", "clean energy", "clean technology",
    "carbon management", "agriculture", "agronomy", "crop science",
    "animal science", "horticulture", "forestry", "soil science",
    "agricultural technology", "ecology", "conservation", "biodiversity",
    "wildlife management", "marine ecology", "restoration ecology",
    "natural resources", "land management", "property management",
    "town planning", "rural management", "food science", "food technology",
    "food safety", "food quality",
  ],
  "hospitality, tourism & service industry": [
    "hospitality", "tourism", "hotel management", "travel management",
    "events management", "event management", "food and beverage",
    "culinary", "recreation", "leisure", "resort", "casino",
    "service management",
  ],
};
